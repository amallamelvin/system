...
<div class="container login-container">
  <form style="display: flex; flex-direction: column;" action="authuser.php" method="post">
    ...
    <div class="card-header" id="negro">
      <p class="text-center">Don't have an account? <a href="signupuser.php" style="text-decoration: none;">Sign-up</a></p>
    </div>
  </form>
</div>
